...
const isNudgePage = location.href.includes('/g/') || location.href.includes('notifications/today')
...
const GreenLifeApp = () => {
  ...
  console.log('isDesktop', isDesktop)
    ...
    // TODO: Rather than hide content, we should let Branch Badge display (great vs cheap mk)
  // Hide content on mobile web.. 
  // if (isIOS || isAndroid) {
